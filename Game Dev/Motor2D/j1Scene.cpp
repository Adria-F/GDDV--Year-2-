...
{	
	...
	text = App->gui->createText("Login", 0, 0, text_font, text_color);
	button = App->gui->createButton(400, 375, NULL, { 13, 188, 129, 25 }, { 13, 188, 129, 25 }, { 167, 188, 129, 25 }, this);
	button->dragable = true;
	button->appendChildAtCenter(text);
	...
	//Input boxes
	App->gui->createInputBox(text_font, {255, 255, 255, 255}, 402, 320, NULL, { 311, 228, 128, 20 }, this)->dragable = true; //Account Password
	App->gui->createInputBox(text_font, { 255, 255, 255, 255 }, 402, 260, NULL, { 311, 228, 128, 20 }, this)->dragable = true; //Account Name
