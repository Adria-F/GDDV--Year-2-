...
j1Player::j1Player()
{
	...
	idle_right = LoadAnimation("animations/player.tmx", "idle_right");
	idle_left = LoadAnimation("animations/player.tmx", "idle_left");

	jumping_right = LoadAnimation("animations/player.tmx", "jumping_right");
	jumping_left = LoadAnimation("animations/player.tmx", "jumping_left");

	falling_right = LoadAnimation("animations/player.tmx", "falling_right");
	falling_left = LoadAnimation("animations/player.tmx", "falling_left");
	...
	right.speed = 0.07f;*/
	right = LoadAnimation("animations/player.tmx", "right");
	...
	left.speed = 0.07f;*/
	left = LoadAnimation("animations/player.tmx", "left");
