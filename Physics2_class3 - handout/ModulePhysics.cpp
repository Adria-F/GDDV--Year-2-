...
int PhysBody::RayCast(int x1, int y1, int x2, int y2, float& normal_x, float& normal_y) const
{
	...
	b2Vec2 point1(x1, y1), point2(x2, y2);
	input.p1 = point1;
	input.p2 = point2;
	...
	for (fixture = body->GetFixtureList(); fixture; fixture = fixture->GetNext())
	{
		if (fixture->RayCast(&output, input, 0))
		{
			...
			b2Vec2 distance = point1 + output.fraction * (point2 - point1);
			ret = (int)distance.Length();
		}
	}
...
{
	LOG("collision!");
	PhysBody* pA = (PhysBody*)contact->GetFixtureA()->GetBody()->GetUserData();
